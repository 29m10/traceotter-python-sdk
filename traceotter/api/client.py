...
class FernTraceotter:
    ...
    x_traceotter_sdk_name : typing.Optional[str]
    x_traceotter_sdk_version : typing.Optional[str]
    x_traceotter_public_key : typing.Optional[str]
