"""Traceotter experiment functionality for running and evaluating tasks on datasets.

This module provides the core experiment functionality for the Traceotter Python SDK,
...
from traceotter.api import ScoreDataType

if TYPE_CHECKING:
    from traceotter._client.datasets import DatasetItemClient


class LocalExperimentItem(TypedDict, total=False):
    """Structure for local experiment data items (not from Traceotter datasets).

    This TypedDict defines the structure for experiment items when using local data
    rather than Traceotter-hosted datasets. All fields are optional to provide
...
- DatasetItemClient: Items from Traceotter datasets with .input, .expected_output, .metadata attributes
"""
...
- List[DatasetItemClient]: Items from a Traceotter dataset (typically from dataset.items)
"""
...
class Evaluation:
    ...
    Attributes:
        ...
        comment: Optional human-readable explanation of the evaluation result.
            ...
            special conditions. Displayed in Traceotter UI for interpretability.
        ...
        config_id: Optional Traceotter score config ID.

    Examples:
        Basic accuracy evaluation:
        ```python
        from traceotter import Evaluation
...
class ExperimentItemResult:
    ...
    Attributes:
        item: The original experiment item that was processed. Can be either
            ...
            or a DatasetItemClient from Traceotter datasets.
        ...
        trace_id: Optional Traceotter trace ID for this item's execution. Used
            to link the experiment result with the detailed trace in Traceotter UI.
        dataset_run_id: Optional dataset run ID if this item was part of a
            Traceotter dataset. None for local experiments.
    ...
    Examples:
        ...
        # Traceotter dataset item (object with attributes)
        else:
            input_data = item_result.item.input
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            trace_id: Optional Traceotter trace ID for this item's execution.
            dataset_run_id: Optional dataset run ID if this item was part of a Traceotter dataset.
...
class ExperimentResult:
    ...
    Attributes:
        ...
        dataset_run_id: Optional ID of the dataset run in Traceotter (when using Traceotter datasets).
        dataset_run_url: Optional direct URL to view the experiment results in Traceotter UI.
    ...
    Examples:
        ...
        Usage with Traceotter datasets:
        ```python
        dataset = traceotter.get_dataset("qa-eval-set")
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            dataset_run_id: Optional ID of the dataset run (for Traceotter datasets).
            dataset_run_url: Optional URL to view results in Traceotter UI.
        """
        self.name = name
    ...
    def format(self, *, include_item_results: bool = False) -> str:
        ...
        - Links to view detailed results in Traceotter UI (when available)
        ...
        Returns:
            ...
            - Dataset run URL for viewing in Traceotter UI (if applicable)
        ...
        **kwargs: Dict[str, Any],
        ...
        Args:
            item: The experiment item to process. Can be either:
                ...
                - Traceotter DatasetItem object with .input, .expected_output attributes
        ...
        Returns:
            ...
            - Traced automatically in Traceotter for observability
        ...
        **kwargs: Dict[str, Any],
        ...
        Args:
            item_results: List of results from all successfully processed experiment items.
                ...
                - trace_id: Traceotter trace ID for this execution
                - dataset_run_id: Dataset run ID (if using Traceotter datasets)
...
async def _run_evaluator(
    ...
    try:
        ...
        logging.getLogger("traceotter").error(f"Evaluator {evaluator_name} failed: {e}")
        return []
...
def create_evaluator_from_autoevals(
    ...
    """Create a Traceotter evaluator from an autoevals evaluator.
    ...
    Returns:
        A Traceotter-compatible evaluator function
    """

    def traceotter_evaluator(
        *,
        input: Any,
        output: Any,
        expected_output: Any,
        metadata: Optional[Dict[str, Any]],
        **traceotter_kwargs: Dict[str, Any],
    ) -> Evaluation:
