...
from traceotter.api.resources.commons.types.dataset import (
    Dataset,  # noqa: F401
)

# these imports need to stay here, otherwise imports from our clients wont work
from traceotter.api.resources.commons.types.dataset_item import DatasetItem  # noqa: F401

# noqa: F401
from traceotter.api.resources.commons.types.dataset_run import DatasetRun  # noqa: F401

# noqa: F401
from traceotter.api.resources.commons.types.dataset_status import (  # noqa: F401
    DatasetStatus,
)
from traceotter.api.resources.commons.types.map_value import MapValue  # noqa: F401
from traceotter.api.resources.commons.types.observation import Observation  # noqa: F401
from traceotter.api.resources.commons.types.trace_with_full_details import (  # noqa: F401
    TraceWithFullDetails,
)

# noqa: F401
from traceotter.api.resources.dataset_items.types.create_dataset_item_request import (  # noqa: F401
    CreateDatasetItemRequest,
)
from traceotter.api.resources.dataset_run_items.types.create_dataset_run_item_request import (  # noqa: F401
    CreateDatasetRunItemRequest,
)

# noqa: F401
from traceotter.api.resources.datasets.types.create_dataset_request import (  # noqa: F401
    CreateDatasetRequest,
)
from traceotter.api.resources.prompts import Prompt, Prompt_Chat, Prompt_Text
...
class TextPromptClient(BasePromptClient):
    ...
    def get_langchain_prompt(self, **kwargs: Union[str, Any]) -> str:
        """Convert Traceotter prompt into string compatible with Langchain PromptTemplate.

        This method adapts the mustache-style double curly braces {{variable}} used in Traceotter
...
class ChatPromptClient(BasePromptClient):
    ...
    def compile(
        ...
        **kwargs: Union[str, Any],
                    ...
                    if isinstance(placeholder_value, list):
                        for msg in placeholder_value:
                            if isinstance(msg, dict):
                                ...
                                traceotter_logger.warning(no_role_content_in_placeholder)
                    else:
                        compiled_messages.append(
                            ChatMessageDict(
                                role="NOT_GIVEN",
                        ...
                        traceotter_logger.warning(placeholder_not_a_list)
                else:
        ...
        if unresolved_placeholders:
            ...
            traceotter_logger.warning(unresolved_placeholders_message)
    ...
    def get_langchain_prompt(
        ...
        """Convert Traceotter prompt into string compatible with Langchain ChatPromptTemplate.

        It specifically adapts the mustache-style double curly braces {{variable}} used in Traceotter
        to the single curly brace {variable} format expected by Langchain.
