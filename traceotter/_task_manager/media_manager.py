...
from traceotter._client.environment_variables import TRACEOTTER_MEDIA_UPLOAD_ENABLED
from traceotter._utils import _get_timestamp
from traceotter.api import GetMediaUploadUrlRequest, PatchMediaBody
from traceotter.api.client import FernTraceotter
from traceotter.api.core import ApiError
from traceotter.api.resources.media.types.media_content_type import MediaContentType
    ...
    def _find_and_process_media(
        ...
        *,
        ...
        def _process_data_recursively(data: Any, level: int) -> Any:
            ...
            if isinstance(data, TraceotterMedia):
                self._process_media(
                    media=data,
                    trace_id=trace_id,
