...
# our own api errors
from traceotter._utils.request import APIError, APIErrors
from traceotter.api.core import ApiError

# fern api errors
from traceotter.api.resources.commons.errors import (
    AccessDeniedError,
    Error,
...
from traceotter.api.resources.health.errors import ServiceUnavailableError

SUPPORT_URL = "https://traceotter.com/support"
API_DOCS_URL = "https://api.reference.traceotter.com"
RBAC_DOCS_URL = "https://traceotter.com/docs/rbac"
INSTALLATION_DOCS_URL = "https://traceotter.com/docs/sdk/typescript/guide"
RATE_LIMITS_URL = "https://traceotter.com/faq/all/api-limits"
PYPI_PACKAGE_URL = "https://pypi.org/project/traceotter/"
