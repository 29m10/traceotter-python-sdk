...
from traceotter.api.core import pydantic_utilities, serialize_datetime
...
class EventSerializer(JSONEncoder):
    ...
    def default(self, obj: Any) -> Any:
        try:
            ...
            if isinstance(obj, TraceotterMedia):
                return (
                    obj._reference_string
                    or f"<Upload handling failed for TraceotterMedia of type {obj._content_type}>"
                )
